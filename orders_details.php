...
<head>
  ...
  <title>ADEV Ventures Ordering System : Order Details</title>
  <!-- Bootstrap -->
...
<body>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a170937_final, tbl_staffs_a170937_final,
          tbl_customers_a170937_final WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      ?>
        <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_series']." ".$productrow['fld_product_name']; ?></option>
      <?php
      }
      $conn = null;
      ?>
