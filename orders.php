...
<head>
  ...
  <title>ADEV Ventures Ordering System : Orders</title>
  <!-- Bootstrap -->
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          <label for="orderdate" class="col-sm-3 control-label">Oder Date</label>
          <div class="col-sm-9">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a170937_final, tbl_staffs_a170937_final, tbl_customers_a170937_final WHERE ";
        $sql = $sql."tbl_orders_a170937_final.fld_staff_num = tbl_staffs_a170937_final.fld_staff_num and ";
        $sql = $sql."tbl_orders_a170937_final.fld_customer_num = tbl_customers_a170937_final.fld_customer_num";
      ...
      <tr>
        ...
        <td>
          ...
          <?php } else if($_SESSION['user_level']=='Normal Staff'){?>
            <a href="orders.php?edit=<?php echo $readrow['fld_order_num']; ?>" class="btn btn-success btn-xs" role="button" disabled> Edit </a>
            <a href="orders.php?delete=<?php echo $readrow['fld_order_num']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button" disabled>Delete</a>
          <?php } ?>
